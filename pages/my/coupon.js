  ...
  return request({
    ...
    const couponsData = res.data.map(d => {
      return {
        ...
        range: coupons[d.relationships.coupon.data.id].attributes.albumId ? `仅限购买“${d.attributes.albumTitle}”` : `全场通用，最高折扣${coupons[d.relationships.coupon.data.id].attributes.value/100}元`,
